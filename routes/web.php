...
Route::view('/info', 'beranda.info')->name('info');
Route::view('/info/panduan', 'beranda.panduan')->name('info.panduan');
...
Route::prefix('produk_seller')->group(function () {
    Route::post('pagination', [ProdukSellerController::class, 'pagination'])->name('produk_seller.pagination');
    Route::post('save', [ProdukSellerController::class, 'save'])->name('produk_seller.save');
    Route::post('update', [ProdukSellerController::class, 'update'])->name('produk_seller.update');
    Route::post('delete', [ProdukSellerController::class, 'delete'])->name('produk_seller.delete');
});
